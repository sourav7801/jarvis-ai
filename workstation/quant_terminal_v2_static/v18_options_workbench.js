...
function style(){
 ...
 "#v18OptionsWorkbench .h{display:flex;justify-content:space-between;gap:8px}.t{font-size:12px;letter-spacing:.12em;color:#e7fbff;font-weight:700}.sub{font-size:7px;color:#6d9baa;margin-top:3px}",
 ...
 "#v18OptionsWorkbench button{cursor:pointer}.active{border-color:#4fc5e8!important;background:#0a2a36!important}.primary{border-color:#37a66f!important;color:#8af0b4!important}",
 "#v18OptionsWorkbench .tabs{display:flex;gap:4px}.status{padding:6px 8px;border-left:2px solid #e2b84d;background:#08171e;color:#d8bd75;font-size:8px;margin-bottom:6px}.status.ok{border-color:#43d58e;color:#8feeb9}.status.err{border-color:#ff667d;color:#ff9aa9}",
 "#v18OptionsWorkbench .summary{display:grid;grid-template-columns:repeat(7,minmax(70px,1fr));gap:4px;margin-bottom:7px}.card{border:1px solid #153b49;background:#06141b;padding:6px}.card small{display:block;color:#628b99;font-size:6px}.card b{display:block;margin-top:3px;color:#e2f7fb;font-size:10px}",
 "#v18OptionsWorkbench .main{display:grid;grid-template-columns:minmax(0,1fr) 270px;gap:7px;min-height:420px}.chain{border:1px solid #153d4b;overflow:auto}.chain table{width:100%;border-collapse:collapse;font-size:7px}.chain th{position:sticky;top:0;background:#0a1c25;color:#7fb8ca;padding:7px 5px;text-align:right}.chain th:first-child,.chain td:first-child{text-align:left}.chain td{padding:6px 5px;border-top:1px solid #0e2b36;text-align:right;white-space:nowrap}.chain tr:hover{background:#0b222c}.chain tr.atm{background:#102b30;box-shadow:inset 2px 0 #45d39a}.ce{color:#8cecb6}.pe{color:#ff9baa}.strike{font-weight:700;color:#f0f8fa}",
 "#v18OptionsWorkbench .side{display:flex;flex-direction:column;gap:6px}.box{border:1px solid #153d4b;background:#06141b;padding:7px}.bt{font-size:7px;color:#77a8b7;letter-spacing:.1em;margin-bottom:6px}.leg{display:grid;grid-template-columns:35px 1fr auto;gap:4px;align-items:center;margin:3px 0;font-size:7px}.leg button{min-height:22px;padding:2px 6px}.note{font-size:6px;color:#5f8998;line-height:1.5}",
 "@media(max-width:1100px){#v18OptionsWorkbench .main{grid-template-columns:1fr}.side{display:grid!important;grid-template-columns:1fr 1fr}.summary{grid-template-columns:repeat(4,1fr)!important}}",
 "@media(max-width:800px){#v18OptionsWorkbench .controls{grid-template-columns:1fr 1fr}.summary{grid-template-columns:repeat(2,1fr)!important}.side{display:block!important}}"
 ].join("");
