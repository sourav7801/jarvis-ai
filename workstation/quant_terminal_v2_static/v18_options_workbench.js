...
function style(){
 ...
 "#v18OptionsWorkbench .main{display:grid;grid-template-columns:minmax(0,1fr) 270px;gap:7px;min-height:420px}#v18OptionsWorkbench .chain{border:1px solid #153d4b;overflow:auto}#v18OptionsWorkbench .chain table{width:100%;border-collapse:collapse;font-size:7px}#v18OptionsWorkbench .chain th{position:sticky;top:0;background:#0a1c25;color:#7fb8ca;padding:7px 5px;text-align:right}#v18OptionsWorkbench .chain th:first-child,.chain td:first-child{text-align:left}#v18OptionsWorkbench .chain td{padding:6px 5px;border-top:1px solid #0e2b36;text-align:right;white-space:nowrap}#v18OptionsWorkbench .chain tr:hover{background:#0b222c}#v18OptionsWorkbench .chain tr.atm{background:#102b30;box-shadow:inset 2px 0 #45d39a}#v18OptionsWorkbench .ce{color:#8cecb6}#v18OptionsWorkbench .pe{color:#ff9baa}#v18OptionsWorkbench .strike{font-weight:700;color:#f0f8fa}",
