# ============================================================
# JARVIS MEAN REVERSION RESEARCH RUNNER
# V1
# ============================================================
...
from agents.mean_reversion_strategy import mean_reversion_strategy
...
class MeanReversionResearchRunner:
    ...
    def research(
        ...
        print(
            "JARVIS MEAN REVERSION RESEARCH > "
    ...
    def format_result(
        ...
        if not result.get(
            ...
            return (
                "MEAN REVERSION RESEARCH FAILED\n"
                "--------------------------------------------------\n"
                +
                str(
                    result.get(
...
if __name__ == "__main__":
    ...
    result = (
        mean_reversion_research_runner.research(
    ...
    print(
        mean_reversion_research_runner.format_result(
            result
        )
    )
    ...
    print(
        "Mean Reversion Research Runner loaded successfully."
    )