# ============================================================
# JARVIS TREND FOLLOWING RESEARCH RUNNER
# V1.2
# ============================================================
#
# Proper expanding walk-forward research.
#
# Important:
#   - Indicators receive historical warm-up data.
#   - Trades are evaluated only on unseen test bars.
...
from agents.trend_following_strategy import (
...
class TrendResearchRunner:
    ...
    def simulate_period(
        ...
        # IMPORTANT:
        # We analyze history through the current bar,
        # but only count trades starting at start_index.
    ...
    def walk_forward(
        ...
        # 200 EMA + meaningful test periods.
        minimum_train = (
        ...
        # test  800:1000
        #
        # The test bars are never used before their fold.
        # ----------------------------------------------------
        ...
        for window in range(
            ...
            # ------------------------------------------------
            # Train only up to the fold boundary.
            # ------------------------------------------------
            ...
            # ------------------------------------------------
            # Test begins after the training boundary.
            #
            # IMPORTANT:
            # We pass the full history to the simulator so
            # indicators have warm-up data, but only trades
            # beginning at test_start are counted.
            # ------------------------------------------------
    ...
    def format_result(
        ...
        lines.append(
            "JARVIS TREND FOLLOWING RESEARCH"
        )
...
if __name__ == "__main__":
    ...
    print(
        "JARVIS TREND FOLLOWING RESEARCH RUNNER V1.2"
    )
    ...
    result = (
        trend_research_runner.research(
    ...
    print(
        trend_research_runner.format_result(
            result
        )
    )
    ...
    print(
        "Trend Research Runner V1.2 loaded successfully."
    )