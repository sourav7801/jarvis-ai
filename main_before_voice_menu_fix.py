...
def tool_exists(tool_name):
    """
    Check whether a registered tool exists.
    """
...
def deterministic_route(text):
    ...
    #
    # We do NOT ask the AI what "both" means.
    # In the current JARVIS setup, "both" means
    # the two applications we just opened:
    #
    #   Notepad
    #   Calculator
    # ========================================================
    ...
    # ========================================================
    # OPEN / START / LAUNCH MULTIPLE APPLICATIONS
    #
    # Examples:
    #
...
def clean_tool_arguments(
    ...
    """
    Remove AI hallucinated arguments.
    ...
    This prevents validation failures caused by
    arguments that the actual registered tool does not support.
    """
    ...
    # --------------------------------------------------------
    # Some registry implementations use
    # "arguments" instead of "schema".
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # If no schema is exposed, let the validator
    # handle it.
    # --------------------------------------------------------
...
def repair_tool_call(
    ...
    The most important repair is close_application.
    ...
    we can infer the application from the original
    user request.
    """
