...
class V16MainWorkstationIntegrationTests(unittest.TestCase):
    ...
    def test_rich_quant_surface_exposes_canonical_long_option_paper_controls(self):
        ...
        self.assertIn("readChartSelection", execution)
        self.assertIn("v16OptionGates", execution)
        self.assertIn("FRESH QUOTE + SESSION AT SUBMIT", execution)
        self.assertIn("Legacy open exposure must be migrated or closed deliberately", execution)
